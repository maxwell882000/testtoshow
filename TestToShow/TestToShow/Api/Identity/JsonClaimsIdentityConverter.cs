...
namespace TestToShow.Api.Identity
{
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            var jObject = new JObject
            {
                ...
                { nameof(ClaimsIdentity.IsAuthenticated), claimsIdentity.IsAuthenticated },
                {
                    ...
                    claimsIdentity.Actor == null ? null : JObject.FromObject(claimsIdentity.Actor, serializer)
                },
                {
                    nameof(ClaimsIdentity.BootstrapContext),
                    claimsIdentity.BootstrapContext == null
                        ? null
                        : JObject.FromObject(claimsIdentity.BootstrapContext, serializer)
                },
                {
                    nameof(ClaimsIdentity.Claims),
                    new JArray(claimsIdentity.Claims.Select(x => JObject.FromObject(x, serializer)))
                },
